    ...
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center space-y-6 relative">
      ...
      >
        <p className="text-lg">
          ...
          with around 11 months of hands-on experience building web applications. I&apos;ve completed a full stack internship and a software trainee role where I worked on real projects using{" "}
          <span className="text-cyan font-semibold">React.js, Node.js, Express.js, MongoDB, and PostgreSQL</span>.
        </p>
        ...
        <p className="text-lg">
          ...
          , JWT authentication, and payment gateway integrations. Having transitioned from{" "}
          <span className="text-orange font-semibold">civil engineering</span>{" "}
          into software development through dedicated self-learning, I have been building and shipping web projects since early 2025.
        </p>
