...
const experiences = [
  {
    ...
    company: "Softnotions Technologies, Technopark",
    date: "Dec 2025 - Feb 2026",
    location: "Trivandrum",
    status: "Completed",
    technologies: ["React.js", "Node.js", "Express.js", "PostgreSQL", "LLaMA API"],
    responsibilities: [
      "Worked on a multi-role web platform covering frontend and backend tasks under senior guidance.",
      "Implemented JWT authentication and RBAC to manage access for 3 different user roles.",
      "Optimized slow PostgreSQL queries using better joins and indexing.",
      "Integrated the LLaMA API to add basic AI recommendations inside the platform.",
      "Joined daily Agile standups, took part in code reviews, and completed sprint tasks."
    ],
    link: ""
  },
  {
    job: "MERN Stack Intern",
    company: "Mashup Stack",
    date: "Apr 2025 - Nov 2025",
    location: "Trivandrum",
    status: "Completed",
    technologies: ["Node.js", "Express.js", "React.js", "Context API", "Postman", "Vercel"],
    responsibilities: [
      "Built and tested REST API endpoints using Node.js and Express.js, including CRUD operations.",
      "Developed reusable React.js components and managed shared state using Context API.",
      "Integrated a third-party payment gateway and external APIs with proper error handling.",
      "Tested all endpoints with Postman before each release.",
      "Deployed builds to Vercel and configured environment variables."
    ],
    link: ""
  }
];
    ...
    <div className="mt-16">
      ...
      >
        ...
        <div className="flex justify-center gap-4">
          ...
          <a 
            href="https://www.linkedin.com/in/abhinand-r-nair-128604222/" 
            target="_blank" 
            rel="noopener noreferrer"
