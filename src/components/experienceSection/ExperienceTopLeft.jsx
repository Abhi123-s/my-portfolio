    ...
    >
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-300 leading-relaxed text-sm">
          With <span className="text-green font-semibold">1 year</span> of hands-on experience 
          in modern web development, I&apos;ve successfully delivered 
          <span className="text-cyan font-semibold"> 5+ projects</span> ranging from 
          dynamic single-page applications to complex platforms.
        </p>
        
        <div className="flex flex-wrap justify-center gap-2 mt-4">
          {['React', 'JavaScript', 'TypeScript', 'GitHub', 'Node.js'].map((tech, index) => (
            <span 
              key={index}
